...
Environment:
    ...
    AGENTMAIL_INBOX:   Inbox address (default: superfluidz@agentmail.to)
"""
...
def main():
    ...
    parser.add_argument(
        "--inbox",
        help="Override inbox address (default: AGENTMAIL_INBOX env or superfluidz@agentmail.to)",
    )
    parser.add_argument(
        "--limit",
        type=int,
    ...
    # --- Resolve inbox ---
    inbox = args.inbox or os.getenv("AGENTMAIL_INBOX", "superfluidz@agentmail.to")
